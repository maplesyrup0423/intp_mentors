...
<head>
<link rel="stylesheet"
	href="${root }resources/style/Booklist_Detail_Style.css" />
<link rel="stylesheet"
	...
	<section id="detail_view">
		...
		<div class="A_view">
			...
			<div class="bookdetail_box">
				<div class="bd_img">
					<div class="img_box">
						<img src="${root }resources/image/인공지능활용교육.jpg" />
					</div>
				</div>
				<div class="bd_info">
					<div class="info_box">
						...
						<div class="list2">
							<ul class="ulist2">
								...
								<button id="sales"
									onclick="location.href='https://product.kyobobook.co.kr/detail/S000209211969'">
									교보문고<img src="${root }resources/image/expand_btn.png" />
								</button>
								<li>링크복사</li>
							</ul>
						</div>
