...
function check_answer() {
	location.href = "${root}class/class_answer?teat_a1=" + a1 + "&teat_a2="
			...
			+ "&teat_a9=" + a9 + "&teat_a10=" + a10 + "&wtt_Key=${wtt_Key}"; //연수-선생님 키 값은 받아오게 나중에 변경
}
</script>
</head>
				...
				<div class="answer" id="answer">
					...
					<div>
						<input type="radio" value="3" name="answer_3"
							onclick="getAnswer3(event)"> <span id="a_num">③</span> <span
							id="a">익스트림 프로그래밍을 구동시키는 원리는 상식적인 원리와 경험을 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;최대한 끌어 올리는 것이다.</span>
					</div>
					<div>
				...
				<div class="answer" id="answer">
					<div>
						<input type="radio" value="1" name="answer_5"
							...
							id="a">시스템의 처리량(Throughput), 반응 시간 등의 성능 요구나 품질 요구는 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;비기능적
							요구에 해당하지 않는다.</span>
					</div>
					<div>
						<input type="radio" value="2" name="answer_5"
							onclick="getAnswer5(event)"> <span id="a_num">②</span> <span
							id="a">'차량 대여 시스템이 제공하는 모든 화면이 3초 이내에 사용자에게 보여야 한다'는 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;비기능적
							요구이다.</span>
					</div>
					<div>
				...
				<div class="answer" id="answer">
					...
					<div>
						<input type="radio" value="2" name="answer_7"
							onclick="getAnswer7(event)"> <span id="a_num">②</span> <span
							id="a">미들웨어의 서비스 이용을 위해 사용자가 정보 교환 방법 등의 내부 동작을 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;쉽게 확인할 수
							있어야 한다.</span>
					</div>
					<div>
				...
				<div class="answer" id="answer">
					...
					<div>
						<input type="radio" value="2" name="answer_9"
							onclick="getAnswer9(event)"> <span id="a_num">②</span> <span
							id="a">다형성이란 여러 가지 형태를 가지고 있다는 의미로, 여러 형태를 받아들일 수 있는<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 특징을
							말한다.</span>
					</div>
					<div>
						<input type="radio" value="3" name="answer_9"
							onclick="getAnswer9(event)"> <span id="a_num">③</span> <span
							id="a">메소드 오버라이딩(Overriding)은 상위 클래스에서 정의한 일반 메소드의 구현을<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 하위
							클래스에서 무시하고 재정의할 수 있다.</span>
					</div>
					<div>
						<input type="radio" value="4" name="answer_9"
							onclick="getAnswer9(event)"> <span id="a_num">④</span> <span
							id="a">메소드 오버로딩(Overloading)의 경우 매개 변수 타입은 동일하지만 메소드명을<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 다르게
