            ...
            <td>
                <table class="table_all">
                    <tr>
                        ...
                        <td class="td_cen">
                            <a href="${root }WT/WT_list" class="top_text">연수신청</a>
                        </td>

                        <!-- <td class="td_cen1"></td> -->

                        <td class="td_cen">
                            <a href="${root }event/event3" class="top_text">이벤트</a>
                        </td>

                        <!-- <td class="td_cen1"></td> -->

                        <td class="td_cen">
                            <a href="${root }book/Booklist" class="top_text">도서관</a>
                        </td>

                        <!-- <td class="td_cen1"></td> -->

                        <td class="td_cen">
                            <a href="${root }WT/WT_my_room" class="top_text">나의 강의실</a>
                        </td>
