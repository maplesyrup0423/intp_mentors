	...
	<div class="all_center">
		...
		<div class="C-main">
			...
			<div class="C-eventList">
                    ...
                    <div class="C-mianimg">
                        <div><img src="${root}resources/image/event_img/event_banner/bannerimg1 (1).png" alt=""></div>
                        <div><img src="${root}resources/image/event_img/event_banner/bannerimg2 (1).jpg" alt=""></div>
                        <div><img src="${root}resources/image/event_img/event_banner/bannerimg3 (1).jpg" alt=""></div>
                        <div><img src="${root}resources/image/event_img/event_banner/bannerimg4 (1).png" alt=""></div>
                        <div><img src="${root}resources/image/event_img/event_banner/bannerimg5 (1).png" alt=""></div>
                    </div>
            ...
            <footer>
                ...
                <div class="C-classlist">
                    ...
                    <div class="list-img">
                        <a href=""><img src="${root}resources/image/event_img/event_Thumb/best-lecture1 (1).png" alt="봇치더락">
                            <p>생각과 마음이 자라는 그림책 수업!</p>
                        </a>
                    </div>

                    <div class="list-img">
                        <a href=""><img src="${root}resources/image/event_img/event_Thumb/best-lecture2 (1).png" alt="k-on">
                            <p>노션으로 만들고 활용하는 디지털 교무수첩</p>
                        </a>
                    </div>

                    <div class="list-img">
                        <a href=""><img src="${root}resources/image/event_img/event_Thumb/best-lecture3 (1).jpg" alt="루시드">
                            <p>인성교육 연구대회 <br>
                                입상을 좌우하는 방법!</p>
                        </a>
                    </div>
                    ...
                    <div class="list-img">
                        <a href=""><img src="${root}resources/image/event_img/event_Thumb/best-lecture4 (1).png" alt="오르카">
                            <p> 법적 의무 교육15선 </p>
                        </a>
                    </div>

                    <div class="list-img">
                        <a href=""><img src="${root}resources/image/event_img/event_Thumb/best-lecture5 (1).jpg" alt="미도와 파라솔">
                            <p>돈으로 움직이는 교실 이야기</p>
                        </a>
                    </div>

                    <div class="list-img">
                        <a href=""><img src="${root}resources/image/event_img/event_Thumb/best-lecture6 (1).png" alt="qwer">
                            <p>내일은 나도 직무 연수 강사</p>
                        </a>
                    </div>
